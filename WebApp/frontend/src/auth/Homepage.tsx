  ...
  return (
    <div className="homepage-main">
      <div className="homepage-first-row">
        <img
          className="first-row-image"
          src={useLaptop}
          alt="Man using excel on a laptop"
        />
      ...
      <HomepageRow title="Understand" titlePosition="left" image={dashboard} />
      <HomepageRow title="Manage" titlePosition="right" image={machines} />
      <HomepageRow title="Optimize" titlePosition="left" image={prediction} />
    </div>
  );
};
...
const HomepageRow: React.FC<{
  ...
  const titleComponent = <div className="homepage-row-title">{title}</div>;
