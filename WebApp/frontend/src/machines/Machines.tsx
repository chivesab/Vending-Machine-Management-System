...
const columns: (
  onButtonClick: (machine: SupplierTypes.Machine) => void
) => TableColumn<SupplierTypes.Machine>[] = (onButtonClick) => [
  {
    name: 'City',
  ...
  {
    cell: (row) => (
      <Button variant="outlined" onClick={() => onButtonClick(row)}>
        Update Stock
      </Button>
    ),
    ignoreRowClick: true,
...
export const Machines: React.FC = () => {
  ...
  const [selectedMachine, setSelectedMachine] = React.useState<
    SupplierTypes.Machine | undefined
  >(undefined);
